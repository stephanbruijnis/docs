...
url: /addons/ats-addon/ht-two-custom-action-helpful-resources
...
| [Guidelines for Creating a Custom Action](ht-two-guidelines-custom-action) | These are the guidelines to follow when creating custom actions. This is a prerequisite for each how-to. |
...
| [Custom Action Basics](ht-two-custom-action-basics) | This is a how-to for the basics of creating a custom action. |
