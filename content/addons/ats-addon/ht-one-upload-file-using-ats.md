...
| :-------------- | :---------------------- | :--------------- | :------------------ |
| Local Selenium Server (Docker) | ![](attachments/ht-one-upload-file-using-ats/grey.png) Limited<sup>1</sup> | ![](attachments/ht-one-upload-file-using-ats/green.png) Yes | ![](attachments/ht-one-upload-file-using-ats/green.png) Yes |
| BrowserStack (SaaS) | ![](attachments/ht-one-upload-file-using-ats/red.png) No | ![](attachments/ht-one-upload-file-using-ats/green.png) Yes | ![](attachments/ht-one-upload-file-using-ats/green.png) Yes |
...
![](attachments/ht-one-upload-file-using-ats/set-file-manager-action.png)
...
![](attachments/ht-one-upload-file-using-ats/file-uploader-widget-app.png)
