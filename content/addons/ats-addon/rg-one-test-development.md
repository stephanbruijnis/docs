...
url: /addons/ats-addon/rg-one-test-development
parent: "rg-one-ats"
---

These are the test development documents:

*   [Object Types in ATS](rg-one-object-types-in-the-ats)
*   [Recorder](rg-one-recorder)
*   [Manual Test Steps](rg-one-manual-test-steps)
*   [Standard Actions](rg-one-standard-actions-reference)
*   [Custom Actions](rg-one-custom-actions)
*   [Best Practices for Writing Custom Actions](rg-one-best-practices)
