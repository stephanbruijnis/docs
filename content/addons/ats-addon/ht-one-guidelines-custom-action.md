...
* Mendix actions are a combination [Mendix actions](rg-one-mendix-actions) and [Mendix Marketplace widget actions](rg-one-mendix-appstore-widgets-actions)
...
![](attachments/ht-one-guidelines-custom-action/standard-input-parameters-2.png)
...
![](attachments/ht-one-guidelines-custom-action/datatype-web-element.png)
